...
<script>
    (function () {
        ...
        function initPostActivityChart() {
            const chartElement = document.querySelector('#post-activity-chart');

            if (! chartElement || typeof ApexCharts === 'undefined') {
                return;
            }

            if (window.postActivityChartInstance) {
                window.postActivityChartInstance.destroy();
                window.postActivityChartInstance = null;
            }
            ...
            window.postActivityChartInstance = new ApexCharts(chartElement, options);
            window.postActivityChartInstance.render();
        }

        document.addEventListener('DOMContentLoaded', initPostActivityChart);
        document.addEventListener('livewire:navigated', initPostActivityChart);
    })();
</script>
